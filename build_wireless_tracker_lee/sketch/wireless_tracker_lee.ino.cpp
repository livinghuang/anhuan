#include <Arduino.h>
#line 1 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
#include "global.h"
...
#line 17 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void interrupt_GPIO0(void);
#line 23 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void VextON(void);
#line 33 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void VextOFF(void);
#line 43 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void enter_deepsleep(void);
#line 58 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void setup();
#line 70 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void loop();
#line 17 "/Users/living/code/github/anhuan/wireless_tracker_lee/wireless_tracker_lee.ino"
void interrupt_GPIO0(void)
{
...
void setup()
{
	...
	st7735.st7735_write_str(0, 0, (String) "Tracker Test Start", Font_7x10, ST7735_WHITE, ST7735_BLACK);
	delay(1000);
...
void loop()
{
	...
	case 2: // battery test
	{
		...
		if (battery_loop())
		{
			Serial.println("end of battery loop");
			count++;
			init = true;
		}
		break;
	...
	case 3: // gsensor test
	{
		...
		if (gsensor_loop())
		{
			Serial.println("end of gsensor loop");
			count++;
			init = true;
		}
		break;
	...
	case 4: // lora test
	{
		...
		if (lora_loop())
		{
			Serial.println("end of lora loop");
			count++;
			init = true;
		}
		break;
	...
	case 6: // dsp310
	{
		...
		if (dsp310_loop())
		{
			Serial.println("end of dsp310 loop");
			count++;
			init = true;
		}
		break;
	...
	case 9: // lorawan test
	{
		...
		if (lorawan_loop())
		{
			Serial.println("end of lorawan loop");
			count++;
			init = true;
		}
		break;
