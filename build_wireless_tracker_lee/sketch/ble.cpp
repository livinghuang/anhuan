#line 1 "/Users/living/code/github/anhuan/wireless_tracker_lee/ble.cpp"
#include "global.h"
...
char paired_hook_mac_address[] = "c1:08:da:00:5a:d7";
...
class MyAdvertisedDeviceCallbacks : public BLEAdvertisedDeviceCallbacks
{
  void onResult(BLEAdvertisedDevice advertisedDevice)
  {
    ...
    if (advertisedDevice.haveName() && advertisedDevice.getName() == "HK9")
    {
      Serial.print("Found Device: ");
      Serial.println(advertisedDevice.toString().c_str());
      ...
      strcpy(ble_mac_address, advertisedDevice.getAddress().toString().c_str());
      Serial.println(ble_mac_address);
      if (strcmp(ble_mac_address, paired_hook_mac_address) == 0)
      {
        hook_done = true;
      }
      else
...
void screen_show_watch_information(void)
{
  st7735.st7735_fill_screen(ST7735_BLACK);
  delay(50);
  st7735.st7735_write_str(0, 0, (String) "Target Device:", Font_7x10, ST7735_WHITE, ST7735_BLACK);
  ...
  if (hook_done)
  {
    st7735.st7735_write_str(80, 0, "HOOK", Font_7x10, ST7735_YELLOW, ST7735_BLACK);
  }
  if ((!watch_done) && (!hook_done))
  {
